...
SpeedChatStaticTextToontown = {
    ...
    1105 : "¡Vamos al %s!" % lToontownCentral,
    1106 : "¡Vamos a %s!" % lDonaldsDock,
    1107 : "¡Vamos a %s!" % lMinniesMelodyland,
    1108 : "¡Vamos a %s!" % lDaisyGardens,
    1109 : "¡Vamos a %s!" % lTheBrrrgh,
    1110 : "¡Vamos a %s!" % lDonaldsDreamland,
    1111 : "¡Vamos a %s!" % lGoofySpeedway,
    1112 : "¡Vamos a mi casa!",
...
AvatarPanelStopIgnor = "Dejar de ignorar"
