...
# All of this is commented out originally because the friend manager was moved
# to the OTP server, But we don't have one on the OTP server as of right now.
...
## #            self.beginInvite(invite)
    ...
    def noFriends(self, invite, yesNoMaybe):
        ...
        if yesNoMaybe == 0 or yesNoMaybe == 3:
            ...
            if not invite.inviteeId in self.declineFriends1:
    ...
    def makeFriends(self, invite):
        ...
        self.air.makeFriends(invite.inviteeId, invite.inviterId, 0, invite.context)
    ...
    def makeSpecialFriends(self, requesterId, avId):
        ...
        self.air.makeFriends(invite.inviteeId, invite.inviterId, 1, invite.context)
